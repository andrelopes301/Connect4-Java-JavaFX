...
public class MiniJogoPalavras  extends EstadoAdapter {
    ...
    public MiniJogoPalavras(Jogo jogo, int jog) {
        super(jogo);
        this.jogador = jog;
    ...
    @Override
    public IEstado ganhouMiniJogoPalavras(boolean ganhou) {
        ...
        if(ganhou) {
            ...
            } // Se ganhou, retorna o mesmo jogador
            if (jogador == 1)
    ...
    public Situacao getSituacao() {
        return Situacao.MiniJogoPalavras;
    }
